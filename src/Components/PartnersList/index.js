...
const PartnersList = () => {
  ...
  const partners = [
    ...
    {
      iconUri:
        'https://the-walks.netlify.app/partners/3_europeanforumalpbach.png',
    },
    {
      iconUri:
        'https://the-walks.netlify.app/partners/4_fondazionearmoniedarte.png',
    },
    {
  ...
  return (
    <FitImage
      ...
      resizeMode="contain"
      source={{
        uri: 'https://the-walks.netlify.app/partners/Koproduzenten.png',
      }}
    />
  )
}
